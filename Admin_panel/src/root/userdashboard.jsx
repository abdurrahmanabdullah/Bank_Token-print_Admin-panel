                    ...
                    >
                      <div className="content" style={{ textAlign: "center" }}>
                        <h3 style={{ marginTop: "20px" }}>
                          ...
                          {moment.utc(Date()).format("hh:mm A - DD-MMMM-YYYY ")}
                        </h3>

                        <h2>Now Serving </h2>
                        <p style={{ color: "#ff4f4f", fontSize: "40px" }}>
                          {/* T-{getwhichservingdata?.detail?.token_id}{" "} */}
                          T
                          {getwhichservingdata?.detail?.token_id
                            ?.toString()
                            .padStart(3, "0")}
                          <br></br>
                          <strong
                            ...
                            <Form.Item>
                              ...
                              <Button
                                ...
                                style={{
                                  ...
                                  color: "#fff",
                                  cursor: "pointer",
                                  WebkitBoxShadow: "0px 2px 8px -3px #000000",
                                  boxShadow: "0px 2px 8px -3px #000000",
                                  transition: "0.2s all",
                                  textDecoration: "none",
                                  width: "250px",
                                  lineHeight: "0em",
