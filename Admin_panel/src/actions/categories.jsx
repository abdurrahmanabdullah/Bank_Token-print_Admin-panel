...
export  const CategoriesStatusUpdate = async (name,status) => {
    ...
    try {
        const response = await axios.patch(`categories/edit-status/${name}`,{
...
export  const CategoriesDelete = async (name) => {
    ...
    try {
        const response = await axios.delete(`categories/delete/${name}`,
             config);
...
export  const EditSequence = async (data ) => {
    ...
    try {
        ...
        const response = await axios.patch(`categories/sequence/edit`,{data:boobs},
        config);
        // console.log(response)
